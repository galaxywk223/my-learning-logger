# learning_logger/models/user_models.py (REVISED)
...
class User(UserMixin, db.Model):
    ...
    # --- REVISED: Added cascade options to all relationships ---
    ...
    milestone_categories = db.relationship('MilestoneCategory', backref='user', lazy='dynamic', cascade="all, delete-orphan")
...
class Setting(db.Model):
    ...
    # The ForeignKey relationship handles the cascade when the user is deleted.
